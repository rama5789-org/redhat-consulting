...
ARTEMIS_HOME='/mnt/c/MyProgramFiles/RedHat/amq-broker-7.7.0'
ARTEMIS_INSTANCE='/mnt/c/MyProgramFiles/RedHat/amq-broker-7.7.0/bin/broker'
ARTEMIS_DATA_DIR='/mnt/c/MyProgramFiles/RedHat/amq-broker-7.7.0/bin/broker/data'
ARTEMIS_OOME_DUMP='/mnt/c/MyProgramFiles/RedHat/amq-broker-7.7.0/bin/broker/log/oom_dump.hprof'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/mnt/c/MyProgramFiles/RedHat/amq-broker-7.7.0/bin/broker/'
ARTEMIS_INSTANCE_ETC_URI='file:/mnt/c/MyProgramFiles/RedHat/amq-broker-7.7.0/bin/broker/etc/'
